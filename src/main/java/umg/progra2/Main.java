...
public static void explicacionUsoMap() {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Para registrar el bot y muestra un mensaje si el registro fue correcto
            botsApi.registerBot(new tareaBot());
            botsApi.registerBot(new botPregunton());
            botsApi.registerBot(new BotRegistra());
            System.out.println("Bot registrado correctamente, felicidades Enner YA PUEDES IRTE A DORMIR.");
